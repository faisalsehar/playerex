! function(e) {
    ...
    var a = function e() {
            ...
            }(this, e), this.message = t, this.props = n, this.error = Error(this.message), this.isUserError = r, this.rollbarFingerprint = this.message
        },
        u = {},
        c = {},
        s = {};
    ...
    var l = function() {
            ...
            return t = e, (n = [{
                    ...
                    return new r.a(function(t, n) {
                        e.createIframeElement().then(function(r) {
                            r.addEventListener("load", function() {
                                ...
                                o && o.document ? t(o.document) : n(e.error())
                ...
                value: function() {
                    ...
                    return new r.a(function(t, n) {
                        "loading" !== e.doc.readyState && e.doc.body ? t() : e.doc.addEventListener("DOMContentLoaded", function() {
                            e.doc.body ? t() : n(new a("host page document.body not available"))
                        })
                    })
                }
            }, {
                ...
                value: function() {
                    ...
                    return new a("iframe document not available to load product", e)
                }
    ...
    var h = function() {
        function e(t, n) {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.product = t, this.version = this.getVersion(n), this.url = this.resolveComposeUrl()
        }
        var t, n, r;
        return t = e, (n = [{
            key: "resolveComposeUrl",
            value: function() {
                var e = this.version ? this.customVersion() : this.product.url;
                return this.version && this.displayWarning(), "".concat(decodeURI(e), "&use_json=true")
            }
        }, {
            key: "displayWarning",
            value: function() {
                console.warn("You are loading ".concat(this.product.name, " version ").concat(this.version.sha))
            }
        }, {
            key: "customVersion",
            value: function() {
                return this.product.url.replace(/\/([a-z0-9]+)\?/, "/".concat(this.version.sha, "?"))
            }
        }, {
            key: "getVersion",
            value: function(e) {
                var t = Object(p.parseUrlParams)(e.location.href).__zE_ac_version;
                if (t) {
                    var n = t.split("/");
                    if (this.validName(n[0]) && this.validSha(n[1])) return {
                        name: n[0],
                        sha: n[1]
                    }
                }
    ...
    var m = function() {
        function e(t, n) {
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e), this.product = t, this.productIframe = new l(this.product, n), this.composeUrlResolver = new h(this.product, n)
        }
        var t, n, o;
        return t = e, (n = [{
            ...
            value: function() {
                ...
                return new r.a(function(n, r) {
                    t ? n(s[e.product.name].assets) : i(e.composeUrlResolver.url).then(function(e) {
                        var t = e.assets;
                        return n(t)
                    }).catch(function() {
            ...
            value: function() {
                var e = this.product,
                    ...
                    n = e.id,
                    r = e.features;
                return new a("compose product request failed", {
                    product: t,
                    id: n,
                    features: r
                }, !1)
            ...
            value: function() {
                var e = this.product,
                    ...
                    n = e.id,
                    r = e.features;
                return new a("failed to load product", {
                    product: t,
                    id: n,
                    features: r
                })
    ...
    var b = function() {
        ...
        return t = e, (n = [{
            ...
            key: "load",
            value: function(e) {
                Object(p.loadScript)(e.zopimSrc)
            }
        ...
        return t = e, (n = [{
            ...
            value: function(e) {
                ...
                return new r.a(function(r, o) {
                    var a = t.snippet.getParentWindow();
                    n ? (a.zEACLoaded = !0, a.$zopim ? r(c.products) : r(u.products)) : i("".concat("https://ekr.zdassets.com/", "compose/").concat(e)).then(function(e) {
                        var t = e.products;
                        a.zEACLoaded = !0, r(t)
                    }).catch(function() {
                        return o(t.error(e))
            ...
            value: function(e) {
                ...
                return e.map(function(e) {
                    return "zopim_chat" === e.name ? new b(e.id, t) : new m(e, t)
                })
            }
        }, {
            key: "error",
            value: function(e) {
                return new a("compose request failed", {
                    key: e
                })
            }
        ...
        return t = e, (n = [{
            ...
            value: function() {
                return new r.a(function(e, t) {
                    return t(new a("Key is missing from snippet", {}, !0))
                })
            }
        }, {
            key: "getZEQueue",
    ...
    var S = function(e) {
        function t() {
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t), j(this, P(t).apply(this, arguments))
        }
        var n, o, u;
        return function(e, t) {
    ...
    var M = function(e) {
        function t() {
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t), C(this, x(t).apply(this, arguments))
        }
        var n, o, i;
        return function(e, t) {
            if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function() {
                ...
                return new r.a(function(t, n) {
                    ...
                    if (r) {
                        var o = Object(p.parseUrlParams)(r.src);
                        if (o && o.key) return t(o.key)
                    }
                    return n(new a("Key is missing from snippet", {}, !0))
                })
            }
        }, {
            key: "getZEQueue",
    ...
    var Q = function(e) {
        function t() {
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t), F(this, U(t).apply(this, arguments))
        }
        var n, o, i;
        return function(e, t) {
            if ("function" != typeof t && null !== t) throw new TypeError("Super expression must either be null or a function");
            ...
            value: function() {
                var e = this;
                return new r.a(function(n, r) {
                    var o = Object(p.getQueryParamsString)(t.getScriptSrc(e.win));
    ...
    var W = null,
        ...
        $ = function() {
            return new r.a(function(e) {
                W ? e(W) : n.e(1).then(n.t.bind(null, 8, 7)).then(function(t) {
                    var n = t.default;
                    W = new n(N), e(W)
                })
            })
    ...
    function B(e) {
        return e && e instanceof a ? $().then(function(t) {
    ...
    try {
        ! function() {
            if (!window.zEACLoaded) {
                var e = function(e) {
                        return M.isSnippetPresent(e) ? new M(e) : e.document.zendeskHost && e.document.zEQueue ? new S(e) : Q.isSnippetPresent(e) ? new Q(e) : new M(e)
                    }(window),
                    t = new w(e);
                e.getKey().then(function(e) {
